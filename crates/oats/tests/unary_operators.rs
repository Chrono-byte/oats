...
"#;
    ...
    codegen.gen_function_ir(&func_name, &func_decl, &func_sig.params, &func_sig.ret, None);

    let ir = codegen.module.print_to_string().to_string();
    
    // Check that fneg instruction is present (unary minus)
    assert!(ir.contains("fneg"), "IR should contain fneg instruction for unary minus");
...
"#;
    ...
    assert!(ir.contains("xor"), "IR should contain xor instruction for NOT");
...
"#;
    ...
    assert!(ir.contains("fptosi") && ir.contains("xor"), 
