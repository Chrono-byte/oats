...
fn gen_add_function_ir_contains_fadd() -> Result<()> {
    ...
    let codegen = CodeGen {
        ...
        generator_yield_live_sets: std::cell::RefCell::new(None),
        generator_local_name_to_slot: std::cell::RefCell::new(None),
        generator_resume_blocks: std::cell::RefCell::new(None),
        generator_cont_blocks: std::cell::RefCell::new(None),
        generator_next_function: std::cell::RefCell::new(None),
        ...
        generator_next_locals: std::cell::RefCell::new(None),
